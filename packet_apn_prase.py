    ...
    if IPv6 in packet and packet.haslayer("IPv6ExtHdrHopByHop"):
        ...
        for option in options:
            if option.otype == 0x3c:
                ...
                mask_bandwith = 0b0000000000000000000000001111111100000000000000000000000000000000
                ...
                QoE_bandwith = (num & mask_bandwith) >> 32  #带宽
                ...
                print("QoE_bandwith: {}".format(bin(QoE_bandwith)[2:]))
                ...
                bandwith    = int(bin(QoE_bandwith), 2)
                delay       = int(bin(QoE_delay), 2)
                loss        = int(bin(QoE_loss), 2)
                qoe_f       = int(bin(QoE_qoe_f), 2)
                qoe = qoe_i + transfer(qoe_f)  
